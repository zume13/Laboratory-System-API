...
namespace Domain.Aggregates.Identity.PatientProfile
{
    public static class PatientProfileErrors
    {
        ...
        public static Error NotFoundByPhysicalId(Guid physicalPatientId) => Error.NotFound("PhysicalPateintID.NotFound", $"No physical ID found for physical patient ID: '{physicalPatientId}");
