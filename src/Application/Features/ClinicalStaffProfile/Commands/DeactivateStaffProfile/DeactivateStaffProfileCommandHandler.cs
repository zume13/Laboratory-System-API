...
{
    public class DeactivateStaffProfileCommandHandler : IRequestHandler<DeactivateStaffProfileCommand, Result>
    {
        private readonly IClinicalProfileRepository _clinicalProfileRepository;
        private readonly IUnitOfWork _unitOfWork;

        public DeactivateStaffProfileCommandHandler(IClinicalProfileRepository clinicalProfileRepository, IUnitOfWork unitOfWork)
        {
            _clinicalProfileRepository = clinicalProfileRepository;
            _unitOfWork = unitOfWork;
        }

        public async Task<Result> Handle(DeactivateStaffProfileCommand request, CancellationToken cancellationToken)
        {
